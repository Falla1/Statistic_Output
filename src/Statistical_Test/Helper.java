...
import Statistical_Test.RandomBing;
...
public class Helper {
    ...
    /*replace the largest value with */
    public static double[] removeLargest(double[] array) {
        double[] newArray = new double[array.length - 1];
        double largst = getMaxValue(array);
